...
public class HoneywellSerialPort {
        ...
        public void run() {
            ...
            try {
                while (mRunning && !isInterrupted()) {
                    ...
                    if (cnt > 0) {
                        HoneywellConstant.byteToHex(" Recv ", cnt, mData);
    ...
    public HoneywellSerialPort(File device, int baudrate, int flags, onDataReceivedListener listener) throws Exception {
    ...
    public boolean sendData(byte[] data) {
        ...
        if (mFileOutputStream != null) {
            try {
                ...
                HoneywellConstant.byteToHex(" Send ", data.length, data);
    ...
    static {
        System.loadLibrary("HoneywellSerial");
    }
}